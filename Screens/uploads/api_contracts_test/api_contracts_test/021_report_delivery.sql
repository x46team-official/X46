...
-- =========================================================
-- TEST 1
-- INVALID REPORT ID (DELIVERY)
-- Expected API: 404
-- =========================================================

SAVEPOINT invalid_report_id_delivery;
...
ROLLBACK TO SAVEPOINT invalid_report_id_delivery;
...
SAVEPOINT invalid_delivery_type;
...
ROLLBACK TO SAVEPOINT invalid_delivery_type;
...
SAVEPOINT invalid_recipient_type;
...
ROLLBACK TO SAVEPOINT invalid_recipient_type;
...
-- =========================================================
-- TEST 4
-- INVALID REPORT ID (RELEASE)
-- Expected API: 404
-- =========================================================

SAVEPOINT invalid_report_id_release;
...
ROLLBACK TO SAVEPOINT invalid_report_id_release;
