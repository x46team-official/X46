...
-- =========================================================
-- TEST 1
-- INVALID ACCESSION TEST (CREATE RESULT ENTRY)
-- Expected API: 404
-- =========================================================
...
SAVEPOINT duplicate_result_entry;
...
ROLLBACK TO SAVEPOINT duplicate_result_entry;
...
-- =========================================================
-- TEST 3
-- INVALID PARAMETER (ADD RESULT DETAIL)
-- Expected API: 404
-- =========================================================

SAVEPOINT invalid_parameter;
...
ROLLBACK TO SAVEPOINT invalid_parameter;
...
-- =========================================================
-- TEST 4
-- DUPLICATE RESULT DETAIL
-- Expected API: 409
-- =========================================================

SAVEPOINT duplicate_result_detail;
...
ROLLBACK TO SAVEPOINT duplicate_result_detail;
...
ROLLBACK TO SAVEPOINT invalid_result_flag;
...
SAVEPOINT invalid_result_status;
...
ROLLBACK TO SAVEPOINT invalid_result_status;
