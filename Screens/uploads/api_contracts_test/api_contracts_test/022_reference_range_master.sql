...
-- =========================================================
-- TEST 1
-- INVALID PARAMETER (CREATE REFERENCE RANGE)
-- Expected API: 404
-- =========================================================

SAVEPOINT invalid_parameter_rr;
...
ROLLBACK TO SAVEPOINT invalid_parameter_rr;
...
SAVEPOINT duplicate_parameter_code;
...
ROLLBACK TO SAVEPOINT duplicate_parameter_code;
...
-- =========================================================
-- TEST 3 (MD021)
-- OVERLAPPING DEMOGRAPHIC BAND
-- Expected API: 409
-- Confirms DB-enforced trigger trg_prevent_reference_range_overlap
-- =========================================================

SAVEPOINT overlapping_demographic_band;
...
BEGIN
    ...
    BEGIN
        ...
        RAISE EXCEPTION
            'API-T173 overlap test failed: overlapping row was accepted';
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            IF SQLERRM LIKE '%overlapping demographic band%' THEN
                ...
                RAISE NOTICE
                    'API-T173 overlap protection PASS: %',
                    SQLERRM;
...
ROLLBACK TO SAVEPOINT overlapping_demographic_band;
...
ROLLBACK TO SAVEPOINT invalid_age_range;
...
SAVEPOINT invalid_effective_date_range;
...
ROLLBACK TO SAVEPOINT invalid_effective_date_range;
...
SAVEPOINT invalid_reference_bounds;
...
ROLLBACK TO SAVEPOINT invalid_reference_bounds;
