...
ROLLBACK TO SAVEPOINT invalid_accession;
...
SAVEPOINT duplicate_report_number;
...
ROLLBACK TO SAVEPOINT duplicate_report_number;
...
-- =========================================================
-- TEST 3
-- DUPLICATE REPORT FOR ACCESSION
-- Expected API: 409
-- =========================================================

SAVEPOINT duplicate_report_for_accession;
...
ROLLBACK TO SAVEPOINT duplicate_report_for_accession;
...
SAVEPOINT invalid_report_status;
...
ROLLBACK TO SAVEPOINT invalid_report_status;
