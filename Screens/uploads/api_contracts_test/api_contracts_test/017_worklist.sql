...
-- =========================================================
-- TEST 1
-- INVALID DEPARTMENT (CREATE WORKLIST)
-- Expected API: 404
-- =========================================================

SAVEPOINT invalid_department;
...
ROLLBACK TO SAVEPOINT invalid_department;
...
-- =========================================================
-- TEST 2
-- DUPLICATE WORKLIST CODE
-- Expected API: 409
-- =========================================================

SAVEPOINT duplicate_worklist_code;
...
ROLLBACK TO SAVEPOINT duplicate_worklist_code;
...
-- =========================================================
-- TEST 3
-- DUPLICATE WORKLIST NAME
-- Expected API: 409
-- =========================================================

SAVEPOINT duplicate_worklist_name;
...
ROLLBACK TO SAVEPOINT duplicate_worklist_name;
...
-- =========================================================
-- TEST 4
-- DUPLICATE WORKSHEET CODE
-- Expected API: 409
-- =========================================================

SAVEPOINT duplicate_worksheet_code;
...
ROLLBACK TO SAVEPOINT duplicate_worksheet_code;
...
SAVEPOINT duplicate_worksheet_name;
...
ROLLBACK TO SAVEPOINT duplicate_worksheet_name;
...
-- =========================================================
-- TEST 6
-- INVALID ACCESSION TEST (WORKLIST ASSIGNMENT)
-- Expected API: 404
-- =========================================================

SAVEPOINT invalid_accession_test_assignment;
...
ROLLBACK TO SAVEPOINT invalid_accession_test_assignment;


-- =========================================================
-- TEST 7
-- INVALID WORKLIST ID (ASSIGNMENT)
-- Expected API: 404
-- =========================================================

SAVEPOINT invalid_worklist_id;
...
ROLLBACK TO SAVEPOINT invalid_worklist_id;
...
-- =========================================================
-- TEST 8
-- INVALID WORKSHEET ID (ASSIGNMENT)
-- Expected API: 404
-- =========================================================

SAVEPOINT invalid_worksheet_id;
...
ROLLBACK TO SAVEPOINT invalid_worksheet_id;
