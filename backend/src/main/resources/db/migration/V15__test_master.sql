...
-- NOTE: source file also contained a trailing
...
-- Omitted here: container_type_master is not created until 028_container_type_master.sql
-- (forward reference), and test_master never gains a container_type_id column
-- anywhere in database/schema/001..040 (dead constraint in the source schema).
