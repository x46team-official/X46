...
\restrict phTZs2c23cWSyjZyx96R1dwbpQhskwZohTwap0E9wQvcSZcEBEyCRi7sZROv7uy
...
--
-- Name: staging_livehealth_results; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.staging_livehealth_results (
    patient_id bigint,
    lab_bill_id bigint,
    order_number text,
    sex text,
...
ALTER TABLE public.staging_livehealth_results OWNER TO postgres;

--
-- Name: staging_livehealth_tests; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.staging_livehealth_tests (
    sr_no integer,
    test_name text,
    test_id text,
    test_code text,
...
ALTER TABLE public.staging_livehealth_tests OWNER TO postgres;
...
--
-- Name: clinical_master clinical_master_organization_id_clinical_type_clinical_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.clinical_master
    ADD CONSTRAINT clinical_master_organization_id_clinical_type_clinical_name_key UNIQUE (organization_id, clinical_type, clinical_name);
...
ALTER TABLE ONLY public.test_parameter_mapping
    ADD CONSTRAINT ug_test_parameter_mapping UNIQUE (organization_id, test_id, parameter_id);
...
ALTER TABLE ONLY public.container_type_master
    ADD CONSTRAINT uq_container_type UNIQUE (organization_id, container_name);
...
--
-- Name: department_master uq_department_name; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.department_master
    ADD CONSTRAINT uq_department_name UNIQUE (organization_id, department_name);
...
ALTER TABLE ONLY public.instrument_master
    ADD CONSTRAINT uq_instrument_code UNIQUE (organization_id, instrument_code);
...
ALTER TABLE ONLY public.instrument_test_mapping
    ADD CONSTRAINT uq_instrument_mapping UNIQUE (organization_id, instrument_id, machine_test_code, machine_parameter_code);
...
ALTER TABLE ONLY public.menu_permission
    ADD CONSTRAINT uq_menu_permission UNIQUE (organization_id, role_id, menu_name);
...
ALTER TABLE ONLY public.notification_template
    ADD CONSTRAINT uq_notification_template UNIQUE (organization_id, template_name, notification_type);
...
ALTER TABLE ONLY public.parameter_master
    ADD CONSTRAINT uq_parameter_master_code UNIQUE (organization_id, parameter_code);
...
ALTER TABLE ONLY public.parameter_master
    ADD CONSTRAINT uq_parameter_master_name UNIQUE (organization_id, parameter_name);
...
ALTER TABLE ONLY public.qc_master
    ADD CONSTRAINT uq_qc_master UNIQUE (organization_id, instrument_id, test_id, parameter_id, qc_level, lot_number);
...
ALTER TABLE ONLY public.report_master
    ADD CONSTRAINT uq_report_accession UNIQUE (organization_id, accession_id);
...
ALTER TABLE ONLY public.report_master
    ADD CONSTRAINT uq_report_number UNIQUE (organization_id, report_number);
...
ALTER TABLE ONLY public.result_authorization
    ADD CONSTRAINT uq_result_authorization UNIQUE (organization_id, result_entry_id);
...
ALTER TABLE ONLY public.result_entry
    ADD CONSTRAINT uq_result_entry UNIQUE (organization_id, accession_test_id);
...
ALTER TABLE ONLY public.role_permission
    ADD CONSTRAINT uq_role_permission UNIQUE (organization_id, role_id, module_name);
...
ALTER TABLE ONLY public.system_configuration
    ADD CONSTRAINT uq_system_configuration UNIQUE (organization_id, config_key);
...
--
-- Name: test_master fk_test_master_container_type; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.test_master
    ADD CONSTRAINT fk_test_master_container_type FOREIGN KEY (container_type_id) REFERENCES public.container_type_master(id);
...
\unrestrict phTZs2c23cWSyjZyx96R1dwbpQhskwZohTwap0E9wQvcSZcEBEyCRi7sZROv7uy
